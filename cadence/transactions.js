export default {
    createPlayer: `
      ...
      transaction(nickname: String) {
        prepare(acct: AuthAccount) {
          // Step1
          acct.save(<- CodeOfFlowDay5_4.createPlayer(nickname: nickname), to: CodeOfFlowDay5_4.PlayerStoragePath)
          // Step2
          acct.link<&CodeOfFlowDay5_4.Player{CodeOfFlowDay5_4.IPlayerPublic}>(CodeOfFlowDay5_4.PlayerPublicPath, target: CodeOfFlowDay5_4.PlayerStoragePath)
          }
        execute {
          log("success")
        }
    ...
    matchingStart: `
      ...
      transaction() {
        prepare(acct: AuthAccount) {
          let gamePlayer = acct.borrow<&CodeOfFlowDay5_4.Player>(from: CodeOfFlowDay5_4.PlayerStoragePath)
