...
2. Terminal画面でAWS Regionを選択します（下図参照）。`,
  ...
  page111_3: `出品を管理するためのforSaleオブジェクト、NFTを引き出すためのCapability、FLOWを入金するためのCapabilityを作成します。赤いパーツを追加します。`,
  page111_4: ``,
  page111_5: ``,
  ...
  page116_4: ``,
  page116_5: ``,
  page117_1: `NFTクリアリングハウス用トランザクションファイルの作成（その1）`,
  ...
  page120_4: ``,
  page120_5: ``,
  page121_1: `NFT取引所のトランザクションファイルを作成する（その2）`,
  page121_2: `ターミナルを開き、プロジェクトのルートに移動して、以下のコマンドを実行します。`,
  page121_3: `VSCodeエディタに戻ります。プロジェクト・ルートに「cadence」というフォルダを作成し、その下にtransactions.jsファイルを作成します。そして、以下のようにソースコードを入力します。`,
  page121_4: ``,
  page121_5: ``,
  page122_1: `7.17.1の内容をコピーして、このファイルの2行目と3行目の間に貼り付けてください。次のようにしてください。`,
  page122_2: ``,
  page122_3: ``,
  page122_4: ``,
  page122_5: ``,
  ...
  page123_4: `Web ブラウザで URL https://flow-view-source.com/ にアクセスします。
  すると、以下のような画面が表示されます。`,
  page123_5: ``,
  ...
  page126_3: `Terminal上で以下のコマンドを実行し、Private Keyを作成します。`,
  page126_4: ``,
  page126_5: ``,
  page127_1: `すると、次のように表示されます。`,
  page127_2: `表示されたこの行の下にあるURLにアクセスします。このサイトでは、公開鍵を元にあなたのFlowアカウントを作成します。(秘密鍵は絶対に公開してはいけません)。

  そして、画面上の「CREATE ACCOUNT」ボタンをクリックします。`,
  page127_3: ``,
  page127_4: ``,
  page127_5: ``,
  ...
  page128_4: ``,
  page128_5: ``,
  page129_1: `PlayGround の 0x02 に配置された MyNFT のソースコードをコピーして、MyNFT.cdc に貼り付けます。また、NonFungbleTokenのアドレスを0x631e88ae7f1d7c20に変更します。
  複数のコントラクトを一度にデプロイできるため、0x04 にデプロイされた NFTClearingHouse スマート コントラクト用の .cdc ファイルも同様に作成します。
  
  contractsに、先ほど作成したスマートコントラクトファイルのパスを設定します。図の赤枠で示したように、flow.jsonの{}の場所に、先ほど作成したスマートコントラクトファイルのパスを設定します。`,
  page129_2: `次に、"deployments "にデプロイするコントラクトの名前を設定します。図の青枠のように"{}"フィールドを設定します。`,
  page129_3: ``,
  page129_4: ``,
  page129_5: ``,
  page130_1: `次に、Terminal上で以下のコマンドを実行します。`,
  page130_2: `デプロイが完了したら、https://flow-view-source.com/testnet/account/(YOUR ACCOUNT)にアクセスし、コントラクトがデプロイされたことを確認します。



  NFTClearingHouseのコントラクトの場合は、同じアドレスのMyNFTのコントラクトをインポートしてください。同じアドレスのコントラクトをインポートする場合は、以下のように相対パスで記述すると、flowコマンドでデプロイする際に自動的にアドレスに置き換わってインポートできます。`,
  page130_3: ``,
  page130_4: ``,
  page130_5: ``,
  page131_1: ``,
