...
2. Select AWS Region on the Terminal screen (see image below).`,
  ...
  page99_5: ``,
  page100_1: ``,
  page100_2: `Setting up a connection between Nuxt.js and Flow Blockchain`,
  ...
  page100_4: `Enter the following code`,
  page100_5: `This code can be found on the webpage at the following URL
